...
CWriteSettingDialog::CWriteSettingDialog(CWnd* pParent /*=NULL*/)
	: CDialog(CWriteSettingDialog::IDD, pParent)
	, m_CueSheetName(_T(""))
	, m_BurnProof(FALSE)
	, m_TestMode(FALSE)
	, m_Opc(FALSE)
...
// CWriteSettingDialog メッセージ ハンドラ
...
{
	// TODO : ここにコントロール通知ハンドラ コードを追加します。
	CFileDialog dlg(TRUE,NULL,NULL,OFN_OVERWRITEPROMPT,MSG(22));
