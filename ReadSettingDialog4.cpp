...
// CReadSettingDialog4 メッセージ ハンドラ
...
void CReadSettingDialog4::Load(void)
{
	...
	if(theSetting.m_Speed_Data <= 1){
		m_Speed.SetCurSel(4);
	} else if(theSetting.m_Speed_Data <= 4){
		m_Speed.SetCurSel(3);
	} else if(theSetting.m_Speed_Data <= 8){
		m_Speed.SetCurSel(2);
	} else if(theSetting.m_Speed_Data <= 32){
		m_Speed.SetCurSel(1);
	} else {
		m_Speed.SetCurSel(0);
	}
