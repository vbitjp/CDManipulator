Copyright 2003, Y.Kanechika. All rights reserved.
...
http://www.storeroom.info/cdm/cdm-license.txt
...
===============================================================================
    ...
    アプリケーション ウィザードが作成した Hermit2 には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには Hermit2 アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
Hermit2.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CHermit2App アプリケーション クラス
    の宣言をします。

Hermit2.cpp
    このファイルは CHermit2App アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\Hermit2.ico
    ...
    リソース ファイル Hermit2.rc によってインクルードされます。
...
Hermit2Dlg.h, Hermit2Dlg.cpp - the dialog
    Tこれらのファイルは CHermit2Dlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な Hermit2.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////

その他の標準ファイル :

StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) Hermit2.pch や既にコン 
