...
CSettingPage2::CSettingPage2(CWnd* pParent /*=NULL*/)
	: CDialog(CSettingPage2::IDD, pParent)
	, m_UseSkin(FALSE)
	, m_SkinFile(_T(""))
	, m_ChangedSkin(false)
...
void CSettingPage2::OnBnClickedBrowsSkin()
{
	// TODO : ここにコントロール通知ハンドラ コードを追加します。
	// TODO : ここにコントロール通知ハンドラ コードを追加します。
	CFileDialog dlg(FALSE,NULL,NULL,OFN_HIDEREADONLY,"Skin files(*.bmp)|*.bmp|All type files|*.*||");
...
{
	// TODO : ここにコントロール通知ハンドラ コードを追加します。
	CFileDialog dlg(FALSE,NULL,NULL,OFN_HIDEREADONLY,"Wav files(*.wav)|*.wav|All type files|*.*||");
